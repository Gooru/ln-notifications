...
class FetchStudentNotificationsCommand {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(FetchStudentNotificationsCommand.class);

  private FetchStudentNotificationsCommand(UUID userId, UUID classId, Long boundary, int limit) {
    this.userId = userId;
  ...
  static FetchStudentNotificationsCommand builder(EventBusMessage input) {
    ...
    return new FetchStudentNotificationsCommand(userId, classId, boundary, limit);
  }
  ...
  public String toString() {
    return "FetchStudentNotificationsCommand{" + "userId=" + userId + ", classId=" + classId
