 ...
 * <p>
 * The notification is initiated from teacher, for specific student from Navigate Next module.
 * Hence, it should be having access to collection as well as current item. Thus this handler won't
 * require a hack to actually read and populate correct context based on path id/type if present.
 *
 * @author ashish.
 */
...
class TeacherSuggestionNotificationsWriterService implements NotificationsWriterService {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(TeacherSuggestionNotificationsWriterService.class);
