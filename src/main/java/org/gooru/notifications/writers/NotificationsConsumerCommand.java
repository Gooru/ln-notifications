...
class NotificationsConsumerCommand {
  ...
  private static NotificationsConsumerCommand createCommandFromEvent(NotificationsEvent event) {
    ...
    command.pathId =
        (event.getPathId() == null || event.getPathId() == 0) ? null : event.getPathId();
  ...
  public void setCollectionId(UUID collectionId) {
    // This code is to enable hack so that we can set collection id later. But we do this only if we
    // are on
    // system path.
    if (isOnSystemPath()) {
      ...
      throw new IllegalStateException(
          "Trying to set collection id in command when it is not on system path");
    }
  }
  ...
  public String toString() {
    return "NotificationsConsumerCommand{" + "userId=" + userId + ", classId=" + classId
        + ", courseId=" + courseId + ", unitId=" + unitId + ", lessonId=" + lessonId
        + ", collectionId=" + collectionId + ", currentItemId=" + currentItemId
        + ", currentItemType='" + currentItemType + '\'' + ", pathType='" + pathType + '\''
        + ", pathId=" + pathId + ", notificationType='" + notificationType + '\'' + ", action='"
        + action + '\'' + ", txCode=" + txCode + ", txCodeType=" + txCodeType + '}';
  }
